...
import { SECTIONS_BY_EVENT_TYPE, getTierFeatures } from "@/lib/event-sections-map";
import { cn } from "@/lib/utils";
import { ImageUploader } from "@/components/shared/ImageUploader";

const sectionToFeatureKey: Record<string, string | null> = {
      ...
      <div className="space-y-8">
        ...
        <div className="grid grid-cols-2 gap-4 sm:grid-cols-3 md:grid-cols-4">
          {Object.keys(activeSections)
            .filter((key) => {
              const featureKey = sectionToFeatureKey[key];
              if (featureKey === null) return true;
              if (featureKey === undefined) return true;
