  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        style={{ backgroundColor: "#1B3A5C", opacity: 0.45, willChange: "transform" }}
      ...
      <motion.div
        ...
        style={{ backgroundColor: "#D4AF7A", opacity: 0.18, willChange: "transform" }}
      ...
      <motion.div
        ...
        style={{ backgroundColor: "#C9A8A0", opacity: 0.14, willChange: "transform" }}
      ...
      <motion.div
        ...
        style={{ backgroundColor: "#D4AF7A", opacity: 0.09, willChange: "transform" }}
